...
#             enroll_mgr.compile_compose(usr, prj)
#             enroll_mgr.build_user_instance(usr, prj)
#
#     # yield data
...
#             for usr in prj_mgr.get_active_users_for_project(prj):
#                 if enroll_mgr.user_instance_is_running(usr, prj):
#                     enroll_mgr.stop_user_instance(usr, prj)
#
#     # yield data
...
#         assert not all(
#             [enroll_mgr.user_instance_is_running(u, p) for u in users]
#         )
#
#
...
#             for module_name in enroll_mgr.get_enrollment(
#                 prj, usr
#             ).modules.keys():
...
#     for prj in prjs:
#         for usr in prj_mgr.get_active_users_for_project(prj):
#             enroll_mgr.start_user_instance(usr, prj)
...
#     enroll_mgr = ctf_app.enroll_mgr
#
#     assert not enroll_mgr.user_instance_is_running(usrs[0], prjs[1])
#
#     with pytest.raises(UserNotEnrolledToProjectException):
#         enroll_mgr.start_user_instance(usrs[0], prjs[0])
#
#     enroll_mgr.start_user_instance(usrs[0], prjs[1])
#     assert enroll_mgr.user_instance_is_running(usrs[0], prjs[1])
#
#     enroll_mgr.enroll_user_to_project(usrs[0].username, prjs[0].name)
#
#     assert not (
#         Path(prjs[0].config_root_dir) / f"{usrs[0].username}_compose.yaml"
#     ).exists()
#     assert not enroll_mgr.user_instance_is_running(usrs[0], prjs[0])
#
#     enroll_mgr.start_user_instance(usrs[0], prjs[0])
#     assert enroll_mgr.user_instance_is_running(usrs[0], prjs[0])
#     assert (Path(prjs[0].config_root_dir) / f"{usrs[0].username}_compose.yaml").exists()
#
#     # clean up
#     enroll_mgr.cancel_enrollment(usrs[0], prjs[0])
#     with pytest.raises(UserNotEnrolledToProjectException):
#         enroll_mgr.user_instance_is_running(usrs[0], prjs[0])
...
#     assert enroll_mgr.user_instance_is_running(usrs[0], prjs[1])
#
#     enroll_mgr.stop_user_instance(usrs[0], prjs[1])
#     assert not enroll_mgr.user_instance_is_running(usrs[0], prjs[1])
#
#     with pytest.raises(UserNotEnrolledToProjectException):
#         enroll_mgr.stop_user_instance(usrs[0], prjs[0])
#
#
...
#     assert not enroll_mgr.user_instance_is_running(usrs[0], prjs[1])
#
#     enroll_mgr.restart_user_instance(usrs[0], prjs[1])
#     assert enroll_mgr.user_instance_is_running(usrs[0], prjs[1])
#
#     with pytest.raises(UserNotEnrolledToProjectException):
#         enroll_mgr.restart_user_instance(usrs[0], prjs[0])
#
#
...
#
#     with pytest.raises(UserNotEnrolledToProjectException):
#         enroll_mgr.build_user_instance(usrs[0], prjs[0])
#
#
...
#         enroll_mgr.start_user_instance(usr, prjs[1])
#
#     deleted_prj = prjs[1]
...
#         enroll_mgr.start_user_instance(usr, prjs[0])
#
#     users = prj_mgr.get_active_users_for_project(prjs[0])
#     enroll_mgr.cancel_multiple_enrollments(
#         [u.username for u in users], prjs[0]
#     )
#
#     for user in users:
#         with pytest.raises(UserNotEnrolledToProjectException):
#             enroll_mgr.user_instance_is_running(user, prjs[0])
